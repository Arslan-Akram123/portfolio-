          ...
          <div className="space-y-8 flex flex-col items-center md:items-start">
            ...
            <div className="flex flex-col space-y-8 sm:items-start">
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col items-start">
                  ...
                  <a
                    href="mailto:arslanakramsoftwareengineer@gmail.com"
            ...
            <div className="pt-8">
              ...
              <div className="flex space-x-4 justify-center">
                <a href="https://www.linkedin.com/in/mdarslan" target="_blank">
                  <Linkedin />
                </a>
                <a href="https://github.com/Arslan-Akram123" target="_blank">
                  <Github />
                </a>
                <a href="https://instagram.com/muhammadarslan1659" target="_blank">
                  <Instagram />
                </a>
              </div>
            </div>
